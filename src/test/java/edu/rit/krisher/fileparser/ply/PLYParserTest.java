...
import edu.rit.krisher.fileparser.ply.PLYParser.ContentDefinition;
import edu.rit.krisher.fileparser.ply.PLYParser.DATA_TYPE;
import edu.rit.krisher.fileparser.ply.PLYParser.ElementDefinition;
import edu.rit.krisher.fileparser.ply.PLYParser.FORMAT;
...
public class PLYParserTest {
   ...
   public void testParseBunnyHeader() throws IOException {
      ...
      Assert.assertEquals(FORMAT.ascii, content.getFormat());
      ...
      Assert.assertEquals(DATA_TYPE.float32, vertexElt.getProperties().get(0).valueType);
      ...
      Assert.assertEquals(DATA_TYPE.float32, vertexElt.getProperties().get(1).valueType);
      ...
      Assert.assertEquals(DATA_TYPE.float32, vertexElt.getProperties().get(2).valueType);
      ...
      Assert.assertEquals(DATA_TYPE.float32, vertexElt.getProperties().get(3).valueType);
      ...
      Assert.assertEquals(DATA_TYPE.float32, vertexElt.getProperties().get(4).valueType);
      ...
      Assert.assertEquals(DATA_TYPE.int32, facesElt.getProperties().get(0).valueType);
      Assert.assertEquals(DATA_TYPE.uint8, facesElt.getProperties().get(0).listIndexType);
   }
}
