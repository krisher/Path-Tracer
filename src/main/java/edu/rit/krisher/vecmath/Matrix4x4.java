...
public final class Matrix4x4 implements Transform {
     ...
     * @return
     */
    public Matrix4x4 mul(double[] mulByMatrix) {
        return multiply(null, matrix, mulByMatrix);
    }

    public Matrix4x4 mul(Matrix4x4 mulBy) {
        return multiply(null, matrix, mulBy.matrix);
    }

    public Matrix4x4 mul(Matrix4x4 _resultM, double[] mulByMatrix) {
        return multiply(_resultM, matrix, mulByMatrix);
    }

    public void mulBy(double[] _mulByMatrix) {
        final Matrix4x4 result = mul(_mulByMatrix);
        System.arraycopy(result, 0, matrix, 0, 16);
    }

    public void mulBy(Matrix4x4 mulBy) {
     ...
     */
    public Vec3 transformPoint(Vec3 _target) {
     ...
     */
    @Override
    public Vec3 transformVec(Vec3 _target) {
        final double x = _target.x * matrix[0] + _target.y * matrix[1]
                + _target.z * matrix[2];
        final double y = _target.x * matrix[4] + _target.y * matrix[5]
                + _target.z * matrix[6];
     ...
     * @return
     */
    public static Matrix4x4 rotationMatrix(Vec3 axis, double angleRads) {
     ...
     * @return
     */
    public static Matrix4x4 rotationXMatrix(double angleRads) {
        final Matrix4x4 rotation = new Matrix4x4();
     ...
     * @return
     */
    public static Matrix4x4 rotationYMatrix(double angleRads) {
        final Matrix4x4 rotation = new Matrix4x4();
     ...
     * @return
     */
    public static Matrix4x4 rotationZMatrix(double angleRads) {
        final Matrix4x4 rotation = new Matrix4x4();
     ...
     * @return
     */
    public static Matrix4x4 composite(Matrix4x4... components) {
        final Matrix4x4 composite = new Matrix4x4();
        for (Matrix4x4 component : components) {
            composite.mulBy(component);
        }
        return composite;
    }

    private static final Matrix4x4 multiply(Matrix4x4 resultM, double[] matrix,
            double[] mulByMatrix) {
        if (resultM == null)
